<div class="adm-info-message-wrap">
    <div class="adm-info-message adm-info-blue">
        <div>Глобальные методы использования модуля:</div>
        <div><strong>Получение значения опции:</strong> cm_option(code, site_id)</div>
